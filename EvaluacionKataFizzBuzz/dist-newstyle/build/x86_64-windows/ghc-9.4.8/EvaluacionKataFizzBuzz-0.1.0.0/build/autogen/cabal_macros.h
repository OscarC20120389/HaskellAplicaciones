...
/* package EvaluacionKataFizzBuzz-0.1.0.0 */
#ifndef VERSION_EvaluacionKataFizzBuzz
#define VERSION_EvaluacionKataFizzBuzz "0.1.0.0"
#endif /* VERSION_EvaluacionKataFizzBuzz */
#ifndef MIN_VERSION_EvaluacionKataFizzBuzz
#define MIN_VERSION_EvaluacionKataFizzBuzz(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EvaluacionKataFizzBuzz */
...
#define CURRENT_PACKAGE_KEY "EvaluacionKataFizzBuzz-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "EvaluacionKataFizzBuzz-0.1.0.0-inplace"
